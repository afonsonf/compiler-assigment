...
#line 44 "parser.bison" /* yacc.c:355  */
...
{
       0,    59,    59,    62,    66,    70,    74,    78,    82,    86,
      90,    94,    99,   103,   107,   111,   115,   119
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MOD", "EQUALS", "DIFF", "LESS", "GREAT", "LESSEQUAL", "GREATEQUAL",
  "ANDLOGIC", "ORLOGIC", "$accept", "program", "boolexpr", "expr", YY_NULLPTR
};
#endif
...
{
      31,    -5,    35,    15,    -4,    -5,    31,    31,    31,    31,
      31,    31,    31,    31,    31,    31,    31,    31,    31,    -5,
      -5,    21,    21,    -5,    -5,    -5,    18,    18,    18,    18,
      18,    18
};
...
#line 62 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr_leaf((yyvsp[0].exprValue));
  }
...
#line 66 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(EQUALS,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 70 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(DIFF,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 74 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(LESS,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 78 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(GREAT,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 82 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(LESSEQUAL,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 86 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr(GREATEQUAL,(yyvsp[-2].exprValue),(yyvsp[0].exprValue));
  }
...
#line 90 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr_complex(ANDLOGIC, (yyvsp[-2].boolValue), (yyvsp[0].boolValue));
  }
...
#line 94 "parser.bison" /* yacc.c:1646  */
    {
    (yyval.boolValue) = ast_boolexpr_complex(ORLOGIC, (yyvsp[-2].boolValue), (yyvsp[0].boolValue));
  }
...
#line 123 "parser.bison" /* yacc.c:1906  */
